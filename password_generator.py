...
numbers= input("Would you like Numbers in your password? (Yes or No)").lower() =='yes'
characters= input("Would you like Special Characters (Ex: $#%^&*@) in your password? (Yes or No)").lower() =='yes'
